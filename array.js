...
let laptops_price = [1500, 2000, 3000, 6500, 9900, 4500];

let expensive_laptops = laptops_price.filter((price) => {
    if (price > 3000) return true;
});

// ex. poduct ma thi specific price na product new array ma store karva hoy
// if you want to show only expensive product on homepage
...
// your are a security gaurd at a shopping mall
// chack the list of visitors
let people = ["John", "Sara", "Mike", "Anna", "David", "Sara"];
// find --> you are looking for the first person named "Sara" in the list and stop searching (Pehli var j male, bas e j and aagal check j na kare)
...
// let products = ["Tablet", "Mobile", "Laptop",
// "Mobile"]
